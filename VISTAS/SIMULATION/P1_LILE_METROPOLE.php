...
<!-- HEAD PAGE -->
<!--------------->
<?php require_once '../HEAD_PAGE.php'; ?>
...
<body class="is-preload">
	...
	<!-------------------->
	<header id="header">
		<a class="title"> MACHINE LEARNING METHODS FOR A CONNECTED TERRITORY </a>
		<?php require_once '../NAVIGATOR_2.php'; ?>
	</header>
	...
	<div id="wrapper">
		...
		<section id="main" class="wrapper">
			<div class="inner">
				...
				<p align="justify">
					For see more details about this simulation, click <a href="https://www.youtube.com/watch?v=BZfzNQd0LeA"> <b style="color:red;"> here </b> </a> to see this video.
				</p>

				<br>

				<span class="image fit">
					<img src="../../IMAGENES/SIMULATION/P1_2.jpg" alt="" />
				</span>
